...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{data\_info }\OtherTok{\textless{}{-}}\NormalTok{ JointXshift}\SpecialCharTok{::}\FunctionTok{simulate\_data}\NormalTok{()}
...
Run the \texttt{JointXshift} main function passing in the data, number of
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim\_results }\OtherTok{\textless{}{-}}\NormalTok{ JointXshift}\SpecialCharTok{::}\FunctionTok{JointXshift}\NormalTok{(}\AttributeTok{W =}\NormalTok{ W,}
