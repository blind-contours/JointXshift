---
title: "`JointXshift`: Semi-Parametric Identification and Estimation of Interaction and Effect Modification in Mixed Exposures using Stochastic Interventions in `R`"
tags:
  - causal inference
  - machine learning
...
The `JointXshift` package has been made publicly available  [via GitHub](https://github.com/blind-contours/JointXshift). Use of the `JointXshift` package has been extensively documented in the package's `README` and a vignette. 
